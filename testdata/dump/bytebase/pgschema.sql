...
CREATE INDEX IF NOT EXISTS idx_audit_log_payload_method ON audit_log ((payload ->> 'method'::text));

--
-- Name: idx_audit_log_payload_parent; Type: INDEX; Schema: -; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_audit_log_payload_parent ON audit_log ((payload ->> 'parent'::text));

--
-- Name: idx_audit_log_payload_resource; Type: INDEX; Schema: -; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_audit_log_payload_resource ON audit_log ((payload ->> 'resource'::text));

--
-- Name: idx_audit_log_payload_user; Type: INDEX; Schema: -; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_audit_log_payload_user ON audit_log ((payload ->> 'user'::text));
